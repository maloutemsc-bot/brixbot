...
| `.history 10` (réponse à un message, @mention ou numéro) | Les 10 derniers messages de la personne dans cette conversation (historique en mémoire du bot, borné à 500 messages par chat) |

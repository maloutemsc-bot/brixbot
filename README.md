...
| `.spamstop` (ou `.spamstop 33612345678`) | Arrête immédiatement le spam en cours dans la conversation (ou celle du numéro passé). Fonctionne aussi quand le bot est éteint (`.bot off`) — même autorisation que `.spam` |
